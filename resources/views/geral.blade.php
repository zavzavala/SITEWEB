...
<a href="{{ url('start') }}"><div class="mouse" href="{{ url('start') }}"></div></a>
	<div class="app">
		...
		<div class="app__img">
			<img onmousedown="return false" src="{{asset('img/importacao3.png')}}" alt="city" />
		</div>
		
		<div class="app__text app__text--1">
			<div class="app__text-line app__text-line--4" style="color:teal;">Importação</div>
			<div class="app__text-line app__text-line--3"><a class="btn btn-info" href="{{ route('Importa&Exportacao') }}">Ver</a></div>
						
		</div>
		
		<div class="app__text app__text--2">
			<div class="app__text-line app__text-line--4" style="color:teal;">Contabilidade </div>
			<div class="app__text-line app__text-line--3"><a class="btn btn-info" href="{{ route('SercicosDeContabilidade') }}">Ver</a>
			</div>
		</div>
