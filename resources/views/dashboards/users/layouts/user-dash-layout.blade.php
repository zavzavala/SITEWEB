...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{ \URL::to('/start')}}" class="brand-link">
      <img src="img/Logotipo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">ImposerC</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
        <img src="{{ Auth::user()->picture }}" class="img-circle elevation-2 auser_picture" alt="User Image">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy;2021 <a href="{{url('https://adminlte.io')}}">AdminLTE.io</a>.</strong> Todos direitos reservados.
  </footer>
</div>
<!-- ./wrapper -->
